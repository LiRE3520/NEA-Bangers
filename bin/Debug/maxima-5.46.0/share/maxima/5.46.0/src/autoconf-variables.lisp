...
(defparameter *autoconf-prefix* "C:/maxima-5.46.0")
(defparameter *autoconf-exec_prefix* "C:/maxima-5.46.0")
(defparameter *autoconf-package* "maxima")
(defparameter *autoconf-version* "5.46.0")
(defparameter *autoconf-libdir* "C:/maxima-5.46.0/lib")
(defparameter *autoconf-libexecdir* "C:/maxima-5.46.0/libexec")
(defparameter *autoconf-datadir* "C:/maxima-5.46.0/share")
(defparameter *autoconf-infodir* "C:/maxima-5.46.0/share/info")
...
(defparameter *maxima-source-root* "/tmp/maxima-5.46.0/crosscompile-windows/build64/maxima-prefix/src/maxima")
